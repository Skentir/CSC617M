...
public class MyGrammerParser extends Parser {
	...
	public final Declare_patternContext declare_pattern() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << DOUBLE) | (1L << FULL) | (1L << HALF) | (1L << QUARTER) | (1L << EIGHTH) | (1L << SIXTEENTH))) != 0) );
			setState(107);
			match(CLOSE_BRACKET);
			}
		}
	...
	public final Measure_blockContext measure_block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ACCIDENTAL_KEY) | (1L << CHORD) | (1L << TUPLET) | (1L << DOUBLE) | (1L << FULL) | (1L << HALF) | (1L << QUARTER) | (1L << EIGHTH) | (1L << SIXTEENTH) | (1L << IDENTIFIER))) != 0) );
			setState(135);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==REPEND) {
	...
	public static final String _serializedATN =
		...
		"d\3\2\2\2de\7*\2\2e\21\3\2\2\2fg\7\r\2\2gi\7)\2\2hj\5\36\20\2ih\3\2\2"+
