...
// STAFF_ACCIDENTAL_KEY: S T A F F A C C I D E N T A L; MEASURE_ACCIDENTAL_KEY: M E A S U R E A C C
// I D E N T A L;
...
expr_add_note:
	COMMA_SEP expr_note
	| COMMA_SEP expr_note expr_add_note;
...
// Functions
declare_staff:
	STAFF OPEN_PAR INTEGER COMMA_SEP INTEGER CLOSE_PAR OPEN_BRACKET (
		staff_block
	)+ CLOSE_BRACKET;
staff_block:
	expr_acc staff_block
	| staff_block expr_acc
	| declare_measures staff_block
	| staff_block declare_measures
	| declare_measures
	| declare_measures_up staff_block
	| staff_block declare_measures_up
	| declare_measures_up;